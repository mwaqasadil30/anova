...
const PageIntro = ({
  ...
  const isSaveDisabled = isLoggedUser || isSubmitting;
  const isLoggedUserTooltipText = t(
    'ui.userEditor.cannotChangeOwnRecord',
    'Cannot make changes to your own user record'
  );
            ...
            >
              <Grid container spacing={2} alignItems="center">
                ...
                {!isInlineForm && (
                  <Grid
                    item
                    title={isLoggedUser ? isLoggedUserTooltipText : ''}
                    {...(isBelowSmBreakpoint && !isInlineForm && { xs: true })}
                  >
                    <SaveButton
                      fullWidth
