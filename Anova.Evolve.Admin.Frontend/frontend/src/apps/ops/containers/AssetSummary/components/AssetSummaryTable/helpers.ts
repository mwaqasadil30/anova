...
export enum AssetSummaryColumnId {
  ...
  AssetSiteNumber = 'asset_SiteNumber',
  DataChannelSiteNumber = 'dataChannel_SiteNumber',
}

// NOTE: These columns/properties are accessed from the RetrieveDomainApplicationInfoById
// api call. This is how we map any cell data to these columns below, which
// belong to the effectiveDomainAssetSummaryTemplate property, containing all
// related columns and their specific ordering.
// EXAMPLE: See how we map the AssetShipTo and DataChannelShipTo columns
export const columnIdToApiProperty: Record<AssetSummaryColumnId, string> = {
  ...
  [AssetSummaryColumnId.AssetSiteNumber]: 'AssetShipTo',
  [AssetSummaryColumnId.DataChannelSiteNumber]: 'DataChannelShipTo',
};
...
export const columnIdToAriaLabel = (columnId: string) => {
  switch (columnId) {
    ...
    case AssetSummaryColumnId.AssetSiteNumber:
      return 'Asset site number';
    case AssetSummaryColumnId.DataChannelSiteNumber:
      return 'Datachannel site number';
    case 'deliverable':
      return 'Deliverable';
...
export const getColumnWidth = (
  ...
  switch (columnId) {
    ...
    case AssetSummaryColumnId.ImportanceLevelImage:
      return 140;
    case AssetSummaryColumnId.RTUDeviceId:
      return isAirProductsDomain ? 180 : 125;
    default:
      return 125;
  }
};
